...
[assembly: InternalsVisibleTo("AimeeKb.Test")]
...
namespace AimeeKb.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is CreateReleaseResponse.StateEnum createReleaseResponseStateEnum)
                return CreateReleaseResponse.StateEnumToJsonValue(createReleaseResponseStateEnum);
            if (obj is DocIngestResponse.StateEnum docIngestResponseStateEnum)
                return DocIngestResponse.StateEnumToJsonValue(docIngestResponseStateEnum);
            if (obj is DrainResponse.StateEnum drainResponseStateEnum)
                return DrainResponse.StateEnumToJsonValue(drainResponseStateEnum);
            if (obj is JobStatusResponse.StatusEnum jobStatusResponseStatusEnum)
                return JobStatusResponse.StatusEnumToJsonValue(jobStatusResponseStatusEnum);
            if (obj is PipelineStatusResponse.StateEnum pipelineStatusResponseStateEnum)
                return PipelineStatusResponse.StateEnumToJsonValue(pipelineStatusResponseStateEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "http://127.0.0.1:8090/v1";
