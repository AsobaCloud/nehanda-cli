...
inputSpec: api/openapi-v1.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{E3707CF5-8650-48BB-8F70-3B71551E7760}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IDeleteDocApiResponse apiResponse = await api.DeleteDocAsync("todo");
...
## Api Information
- appName: aimee-kb API
- appVersion: 1
- appDescription: Public HTTP API for the aimee knowledge-base sidecar (aimee-kb). Enabled by setting kb.api.http_port in aimee config. Optional bearer-token auth via kb.api.bearer_token. 
