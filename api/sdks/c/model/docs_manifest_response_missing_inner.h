/*
 * docs_manifest_response_missing_inner.h
 *
 * 
 */

#ifndef _docs_manifest_response_missing_inner_H_
#define _docs_manifest_response_missing_inner_H_
...
typedef struct docs_manifest_response_missing_inner_t docs_manifest_response_missing_inner_t;




typedef struct docs_manifest_response_missing_inner_t {
    char *doc_key; // string
    char *content_hash; // string
    char *scope; // string

    int _library_owned; // Is the library responsible for freeing this object?
} docs_manifest_response_missing_inner_t;
...
#endif /* _docs_manifest_response_missing_inner_H_ */
