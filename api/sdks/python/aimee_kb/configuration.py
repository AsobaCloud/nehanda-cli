...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "http://127.0.0.1:8090/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("aimee_kb")
        ...
        return [
            {
                ...
                'variables': {
                    'port': {
                        'description': "Configured kb_api_http_port",
                        'default_value': "8090",
                        }
                    }
            }
