...
static const char *ENFORCED_OK = "name: mc\n"
                                 "enforced: true\n"
                                 "start: u\n"
                                 "nodes:\n"
                                 "  - id: u\n"
...
static const char *REVIEWER_MISSING = "name: norev\n"
                                      "enforced: true\n"
                                      "start: u\n"
                                      "nodes:\n"
                                      "  - id: u\n"
...
static const char *ENFORCED_NO_DELIVER = "name: bad\n"
                                         "enforced: true\n"
                                         "start: u\n"
                                         "nodes:\n"
                                         "  - id: u\n"
...
static const char *ENFORCED_ALT_EXIT = "name: alt\n"
                                       "enforced: true\n"
                                       "start: u\n"
                                       "nodes:\n"
                                       "  - id: u\n"
...
static const char *REVIEWER_CLASH = "name: clash\n"
                                    "enforced: true\n"
                                    "start: u\n"
                                    "nodes:\n"
                                    "  - id: u\n"
...
static const char *UNENFORCED_OK = "name: plain\n"
                                   "start: u\n"
                                   "nodes:\n"
                                   "  - id: u\n"
                                   "    block: understand\n";
